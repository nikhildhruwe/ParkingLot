...
import com.bridgelabz.parkinglot.utliity.ParkingSlotDetails;
...
public class ParkingLot {
    ...
    private void initialise(ArrayList<ParkingSlotDetails> parkingSlotList) {
        if (parkingSlotList.isEmpty())
            IntStream.range(0, maxCapacity).mapToObj(slot -> this.parkingSlotDetails).forEach(parkingSlotList::add);
    }
