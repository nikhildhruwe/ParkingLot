...
public class ParkingLotTest {
    ...
    public void givenVehiclesToPark_WhenThereIsMultipleLots_ShouldBeEvenlyDistributedInParkingLots() {
        ...
        parkingLotSystem.parkVehicle(firstCar, DriverType.NORMAL, "abc");
        parkingLotSystem.parkVehicle(secondCar, DriverType.NORMAL, "abc");
        parkingLotSystem.parkVehicle(thirdCar, DriverType.NORMAL, "abc");
        parkingLotSystem.unParkVehicle(secondCar);
        parkingLotSystem.parkVehicle(fourthCar, DriverType.NORMAL, "abc");
    ...
    public void givenDriverType_IfHandicap_ShouldALotNearestParkingSlot() {
        ...
        parkingLotSystem.parkVehicle(firstCar, DriverType.NORMAL, "abc");
        parkingLotSystem.parkVehicle(secondCar, DriverType.NORMAL, "abc");
        parkingLotSystem.parkVehicle(thirdCar, DriverType.HANDICAP, "abc");
        parkingLotSystem.parkVehicle(fourthCar, DriverType.HANDICAP, "abc");
        int vehicleLotLocation = parkingLotSystem.getVehicleLotNumber(fourthCar);
        int vehicleSlotNumber = parkingLotSystem.getVehicleSlotNumber(fourthCar);
    ...
    public void givenLargeVehicle_WhenParked_ShouldParkInLotWithHighestNumberOfSlots() {
        ParkingLotSystem parkingLotSystem = new ParkingLotSystem(3, 3);
        Car firstCar = new Car(VehicleSize.SMALL, "blue");
        Car secondCar = new Car(VehicleSize.SMALL, "green");
        Car thirdCar = new Car(VehicleSize.SMALL, "grey");
        Car fourthCar = new Car(VehicleSize.LARGE, "red");
    ...
    public void givenVehiclesInParkingLot_IfColorIsWhite_ShouldReturnLocation() {
        ParkingLotSystem parkingLotSystem = new ParkingLotSystem(3, 3);
        Car firstCar = new Car(VehicleSize.SMALL, "blue");
        Car secondCar = new Car(VehicleSize.SMALL, "white");
        Car thirdCar = new Car(VehicleSize.SMALL, "orange");
        Car fourthCar = new Car(VehicleSize.SMALL, "white");
    ...
    public void givenBlueToyotaCar_IfPresent_ShouldReturnLocation() {
        ParkingLotSystem parkingLotSystem = new ParkingLotSystem(3, 3);
        Car firstCar = new Car(VehicleSize.SMALL, VehicleCompany.TOYOTA, "blue", "a123");
        ...
        Car fourthCar = new Car(VehicleSize.SMALL, VehicleCompany.KIA, "grey", "d567");
        Car fifthCar = new Car(VehicleSize.SMALL, VehicleCompany.TOYOTA, "grey", "e899");
        ...
        parkingLotSystem.parkVehicle(fourthCar, DriverType.NORMAL, "firstAttendant");
        parkingLotSystem.parkVehicle(fifthCar, DriverType.NORMAL, "secondAttendant");
    ...
    public void givenBlueToyotaCar_IfNotPresent_ShouldThrowException() {
        ParkingLotSystem parkingLotSystem = new ParkingLotSystem(3, 3);
        Car firstCar = new Car(VehicleSize.SMALL, VehicleCompany.MAHINDRA, "blue", "a123");
        Car secondCar = new Car(VehicleSize.SMALL, VehicleCompany.BMW, "white", "b234");
        Car thirdCar = new Car(VehicleSize.SMALL, VehicleCompany.MARUTI, "blue", "c456");
        try {
            parkingLotSystem.parkVehicle(firstCar, DriverType.NORMAL, "firstAttendant");
    ...
    public void givenVehiclesToPark_IfGivenCompanyVehiclePresent_ShouldReturnParkingDetailsOfVehicle() {
        ...
        Car secondCar = new Car(VehicleSize.SMALL, VehicleCompany.BMW, "white", "b234");
        Car thirdCar = new Car(VehicleSize.SMALL, VehicleCompany.MARUTI, "blue", "c456");
        Car fourthCar = new Car(VehicleSize.SMALL, VehicleCompany.BMW, "grey", "d567");
    ...
    public void givenVehicleBMW_IfNotPresent_ShouldThrowException() {
        ParkingLotSystem parkingLotSystem = new ParkingLotSystem(3, 3);
        Car firstCar = new Car(VehicleSize.SMALL, VehicleCompany.MAHINDRA, "blue", "a123");
        Car secondCar = new Car(VehicleSize.SMALL, VehicleCompany.MARUTI, "blue", "c456");
        try {
            parkingLotSystem.parkVehicle(firstCar, DriverType.NORMAL, "firstAttendant");
            parkingLotSystem.parkVehicle(secondCar, DriverType.NORMAL, "thirdAttendant");
